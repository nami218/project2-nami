...
@section('content')
     ...
     <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-items set-bg" data-setbg="{{ asset('client/img/banner-draft-5.jpg') }}">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>KHÓA ĐIỆN TỬ</span>
                            <h1>VÂN TAY</h1>
                            <p>Giải pháp an ninh chuyên nghiệp cho nhà trọ, nhà riêng, homestay, hotel và văn phòng công ty. Công nghệ hiện đại giúp quản lý người dùng hiệu quả và tiện lợi </p>
            ...
            <div class="single-hero-items set-bg" data-setbg="{{ asset('client/img/banner-draft-6.jpg') }}">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>6 IN 1 PHƯƠNG THỨC</span>
                            <h1>MỞ KHÓA</h1>
                            <p>Vân tay - thẻ từ - mật mã - remote từ xa - chìa cơ - app điện thoại. Kèm tính năng lưu điện, mở khóa từ xa, báo động nhắc quên đóng cửa</p>
                            <a href="#" class="primary-btn">Shop Now</a>
                        </div>
                    </div>
                    <div class="off-card">
    ...
    <!-- Banner Section End -->
     ...
     <section class="deal-of-week set-bg spad" data-setbg="{{ asset('client/img/time-bg.jpg') }}">
        <div class="container">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8">
                    <div class="filter-control">
                        <ul>
                            <li class="active">Khóa cổng dùng pin</li>
                            <li>Khóa vân tay cửa gỗ</li>
                            <li>Khóa vân tay cửa xingfa</li>
                        </ul>
                    </div>
                    <div class="product-slider owl-carousel">
                        <div class="product-item">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="product-large set-bg m-large" data-setbg="{{ asset('client/img/products/large-draft.jpg') }}">
                        <h2>Men’s</h2>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-1">
                    <div class="filter-control">
                        <ul>
                            <li class="active">Khóa vân tay dùng pin</li>
                            <li>Cổng trượt tự động</li>
                            <li>Phụ kiện</li>
                        </ul>
                    </div>
                    <div class="product-slider owl-carousel">
